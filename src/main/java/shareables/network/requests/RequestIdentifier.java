...
public enum RequestIdentifier {
    ...
    SAVE_HOMEWORK,
    GET_HOMEWORK_DESCRIPTION,
    GET_HOMEWORK_PDF,
    GET_HOMEWORK_SUBMISSION_TYPE,
    SUBMIT_HOMEWORK_TEXT,
    SUBMIT_HOMEWORK_MEDIA,
    GET_SUBMISSION_THUMBNAIL_DTOS,
    GET_SUBMISSION_TEXT,
    DOWNLOAD_SUBMISSION_MEDIA_FILE,
    SCORE_STUDENT_SUBMISSION,
    GET_STUDENT_GLOBAL_CALENDAR_EVENT_DTOS,
    GET_PROFESSOR_GLOBAL_CALENDAR_EVENT_DTOS,
    GET_STUDENT_SCORE
}