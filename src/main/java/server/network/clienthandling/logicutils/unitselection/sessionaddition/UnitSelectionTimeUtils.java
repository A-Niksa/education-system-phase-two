package server.network.clienthandling.logicutils.unitselection.sessionaddition;
...
public class UnitSelectionTimeUtils {
    public static UnitSelectionSession getStudentFutureUnitSelectionSession(DatabaseManager databaseManager, Student student) {
    ...
    public static boolean isCurrentTimeInTimeRange(LocalDateTime rangeStartsAt, LocalDateTime rangeEndsAt) {
